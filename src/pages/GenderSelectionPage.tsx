      ...
      <main className="container mx-auto px-4 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Choose your preference in <span className="text-primary font-semibold">{region}</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-card-foreground">Female</CardTitle>
            </CardHeader>
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-card-foreground">Male</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-muted-foreground mb-6">
